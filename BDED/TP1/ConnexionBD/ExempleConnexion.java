    ...
    public static void main(String[] args) {
        try {
            ...
            */
            ...
            int resultExecuteUpdate = stmtExecuteUpdate.executeUpdate("INSERT INTO bank VALUES(200,500)");
            ...
            */
            ...
            /*PreparedStatement preparedStmt2 = connexion.prepareStatement("INSERT INTO bank VALUES (350,1900)");
            //preparedStmt.setInt(1, 100);
            ResultSet rsPreparedStmt2 = preparedStmt2.executeQuery();*/
            
            
            PreparedStatement preparedStmt = connexion.prepareStatement("SELECT id FROM bank");
            //preparedStmt.setInt(1, 100);
            ResultSet rsPreparedStmt = preparedStmt.executeQuery();
            while (rsPreparedStmt.next()) {
                int id = rsPreparedStmt.getInt(1);
